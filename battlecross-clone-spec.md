...
Projeto de teste para criar, em navegador, um **clone do jogo _Battle Cross_** (Super Nintendo / Super Famicom), originalmente desenvolvido pela **A-Max** e publicado pela **Imagineer** em **9 de dezembro de 1994** (exclusivo Japão).
...
- **Gênero:** corrida de festa / _party racer_ — mistura de _Super Sprint_ (top-down) com itens estilo _Mario Kart_/_Bomberman_
...
- **Assistência:** o original tem _auto-steering_ opcional (modo humano-CPU) para iniciantes/crianças — **decidimos NÃO incluir** na v1.
...
- Wikipedia — _Battle Cross (1994 video game)_
- Snes Central — _Battle Cross Review_ (Evan G.)
...
- **React gerencia:** telas de menu, seleções, opções, overlay de pausa e a tela de resultados — comunicando via um _game-store_ (estado global) + eventos.
...
- CPU segue o caminho da pista via _path following_ (waypoints/checkpoints).
