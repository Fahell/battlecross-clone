...
- `howler` + assets royalty-free (Kenney _Interface Sounds_ / _Racing_ packs; OpenGameArt p/ música).
...
- **Núcleo:** _party racer_ caótico — corridas curtas, tela única, tudo pode acontecer até a última curva.
- **Física:** escorregadia, mas _justa_ — o jogador sente progresso ao dominar a derrapagem; curvas bem feitas dão vantagem real.
